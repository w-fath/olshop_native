...
(window._gsQueue || (window._gsQueue = [])).push(function () {
  _gsDefine("plugins.ScrollToPlugin", ["plugins.TweenPlugin"], function (a) {
    var b = function () {
        a.call(this, "scrollTo"), this._overwriteProps.pop()
      },
      c = b.prototype = new a("scrollTo"),
      d = document.documentElement,
      e = window,
      f = b.max = function (a, b) {
        var c = "x" === b ? "Width" : "Height",
          f = "scroll" + c,
          g = "client" + c,
          h = document.body;
        return a === e || a === d || a === h ? Math.max(d[f], h[f]) - Math.max(d[g], h[g]) : a[f] - a["offset" + c]
      },
      g = a.prototype.setRatio;
    return c.constructor = b, b.API = 2, c._onInitTween = function (a, b, c) {
      return this._wdw = a === e, this._target = a, this._tween = c, "object" != typeof b && (b = {
        y: b
      }), this._autoKill = b.autoKill !== !1, this.x = this.xPrev = this.getX(), this.y = this.yPrev = this.getY(), null != b.x ? this._addTween(this, "x", this.x, "max" === b.x ? f(a, "x") : b.x, "scrollTo_x", !0) : this.skipX = !0, null != b.y ? this._addTween(this, "y", this.y, "max" === b.y ? f(a, "y") : b.y, "scrollTo_y", !0) : this.skipY = !0, !0
    }, c.getX = function () {
      return this._wdw ? null != e.pageXOffset ? e.pageXOffset : null != d.scrollLeft ? d.scrollLeft : document.body.scrollLeft : this._target.scrollLeft
    }, c.getY = function () {
      return this._wdw ? null != e.pageYOffset ? e.pageYOffset : null != d.scrollTop ? d.scrollTop : document.body.scrollTop : this._target.scrollTop
    }, c._kill = function (b) {
      return b.scrollTo_x && (this.skipX = !0), b.scrollTo_y && (this.skipY = !0), a.prototype._kill.call(this, b)
    }, c.setRatio = function (a) {
      g.call(this, a);
      var b = this._wdw || !this.skipX ? this.getX() : this.xPrev,
        c = this._wdw || !this.skipY ? this.getY() : this.yPrev,
        d = c - this.yPrev,
        f = b - this.xPrev;
      this._autoKill && (!this.skipX && (f > 7 || -7 > f) && (this.skipX = !0), !this.skipY && (d > 7 || -7 > d) && (this.skipY = !0), this.skipX && this.skipY && this._tween.kill()), this._wdw ? e.scrollTo(this.skipX ? b : this.x, this.skipY ? c : this.y) : (this.skipY || (this._target.scrollTop = this.y), this.skipX || (this._target.scrollLeft = this.x)), this.xPrev = this.x, this.yPrev = this.y
    }, a.activate([b]), b
  }, !0)
...
$.fn.formatAmount = function (e) {
  var elem = this;
  elem.on('keyup', function () {
    var decimalInput = this;
...
function accordionKomite() {
  let elem = $('.accordion');
  elem.find('.box-acc').each(function () {
    $('.box-acc:first').addClass('active');
    if ($(this).hasClass('active')) {
      $(this).find('.acc-body').show();
    }
  });
  elem.find('.box-acc .acc-head').click(function () {
    if (!$(this).parent().hasClass('active')) {
      $('.accordion .box-acc').removeClass('active');
      $('.box-acc .acc-body').stop().slideUp(400);
      $(this).parent().addClass('active');
      $(this).parent().find('.acc-body').stop().slideDown(400);
    } else {
      $(this).parent().removeClass('active');
      $(this).parent().find('.acc-body').stop().slideUp(400);
...
function sliderHome() {
  ...
  if (elem.length) {
    ...
    TweenLite.set([caps.find('.dotted'), caps.find('h1'), caps.find('p'), caps.find('p')], {
      css: {
        'position': 'relative'
      }
    });
...
function animCaption(type) {
  ...
  if (type === "in") {
    // TweenLite.to([caps.find('h1'), caps.find('p'), caps.find('a'), caps.find('.dotted'), caps.find('.tabs')], 0.4, {css: {'left': '-50px','opacity': '0',},ease: Quart.easeOut});
    // console.log("as");
  } else {
    TweenLite.to(caps.find('.dotted'), 0.4, {
      css: {
        'left': '0',
        'opacity': '1',
      },
    ...
    TweenLite.to(caps.find('.tabs'), 0.4, {
      css: {
        'left': '0',
        'opacity': '1',
      },
...
function animService() {
  if ($(".right-service").length) {
    var elem = $(".right-service"),
      ...
      scar = elem.find(".scar"),
      dots = elem.find(".dots"),
      tab = elem.find(".tab-rec"),
      triggerElem = $(".trig-service");

    if (mcycle) {
      TweenLite.set(mcycle, {
        css: {
          'opacity': '0'
        }
      });
...
function animProduct() {
  if ($(".produkkredit").length) {
    ...
    TweenLite.set(bgwhite, {
      scale: 1.1,
      opacity: 0
    });
    TweenLite.set(lsproduk, {
      css: {
        'opacity': '0',
        'position': 'relative',
        'top': '10px'
    ...
    anim.runanim = function () {
      elem.each(function (i) {
        elem_ = $(this);
        if (triggerElem.isOnScreen() && !elem.hasClass('animated')) {
          TweenLite.to(bgwhite, 0.5, {
            opacity: 1,
            delay: 1.4,
            scale: 1,
            ease: Power2.easeOut
          }, 0.2);
          TweenMax.staggerTo(lsproduk, 0.8, {
            opacity: 1,
            delay: 1.8,
            top: 0,
            ease: Power2.easeOut
  ...
  if ($(".testimonihome").length) {
    ...
    anim.runanim = function () {
      elem.each(function (i) {
        ...
        if (triggerElem.isOnScreen() && !elem.hasClass('animated')) {
          setHeightTestimoni();
          TweenMax.staggerTo(lstestimoni, 0.8, {
            opacity: 1,
            delay: 1.4,
            scale: 1,
            ease: Power2.easeOut
  ...
  if ($(".sponsorhome").length) {
    ...
    anim.runanim = function () {
      elem.each(function (i) {
        elem_ = $(this);
        if (triggerElem.isOnScreen() && !elem.hasClass('animated')) {
          TweenMax.staggerTo(lssponsor, 0.8, {
            opacity: 1,
            delay: 1,
            scale: 1,
            ease: Power2.easeOut
...
function dropDownNav() {
  ...
  $(".mainmenu span.arr").click(function (e) {
    e.preventDefault();
    if (!$(this).hasClass('active')) {
      $(".mainmenu span.arr.active").parent().find('.drop-menu').slideUp(300);
      $(".mainmenu span.arr.active").removeClass('active');
  ...
  $(".drop-menu li a").not($(".drop-sub li a")).click(function (e) {
    if ($(this).parent().hasClass('menu-single'))
      return true;
    e.preventDefault();
    if (!$(this).hasClass('active')) {
      $(".drop-menu li a.active").parent().find('.drop-sub').slideUp(300);
      $(".drop-menu li a.active").removeClass('active');

      $(this).addClass('active');
      $(this).parent().find('.drop-sub').slideToggle(300);
    } else {
      $(".drop-menu li a.active").parent().find('.drop-sub').slideUp(300);
      $(".drop-menu li a.active").removeClass('active');
    }
...
function tabs() {
  ...
  $('.tabs .nav-tab a').click(function (e) {
    e.preventDefault();
    var $tabs = $(this).closest('.tabs');
    $tabs.find('.nav-tab a.active').removeClass('active');
    $(this).addClass('active');

    $tabs.find('div.tab-content:not(:hidden)').hide();
    $(this.hash).fadeIn(100);

    $('.product-teaser-list.matching .row').slick("unslick");
    // productMatching(); 

    $('.slide-inspirasi .row').slick("unslick");
    sliderInspirasi();
...
function tabSlideRight() {
  var act = function () {
    var right = ($(window).width() - $(".head-bottom").width()) / 2;
    $(".tab-rec").css({
      right: right + "px"
    })
  }
...
function setHeightTestimoni() {
  if ($(window).width() > 690) {
    if ($(".box-list-testimoni .list-testimoni .inner-testimoni").length) {
      var count = $(".box-list-testimoni .list-testimoni").length;
      $(".box-list-testimoni .list-testimoni .inner-testimoni").autoheight({
        outer: true,
        column: count
      });
    }
    ...
    if ($(".box-list-testimoni .list-testimoni .inner-testimoni").length) {
      $(".box-list-testimoni .list-testimoni .inner-testimoni").css({
        'height': 'auto'
      });
    }
  }
...
function overlay_pop() {
  $('.overlay_pop').on('click', function () {
    ...
    TweenLite.to($('.wrap_pop .content_pop'), 0.5, {
      css: {
        'opacity': '0',
        'scale': '0.9'
      },
...
function listContent() {
  var elem = $('.wrap-accordion');
  elem.find('.list-acc').each(function () {
    if ($(this).hasClass('act')) {
      $(this).find('.content-acc').show();
    }
  });
  elem.find('.list-acc .grid-acc').click(function () {
    if (!$(this).parent().hasClass('act')) {
      $('.wrap-accordion .list-acc').removeClass('act');
      $('.list-acc .content-acc').stop().slideUp(300);
      $(this).parent().addClass('act');
      $(this).parent().find('.content-acc').stop().slideDown(300);
    } else {
      $(this).parent().removeClass('act');
      $(this).parent().find('.content-acc').stop().slideUp(300);
...
$(document).ready(function () {
  ...
  // $('.menu-id ul li').mouseover(function(){
  //     $('body').css('overflow','hidden');
  // });
  // $('.menu-id ul li').mouseleave(function(){
  //     $('body').removeAttr('style');
  // });

  // $(".tool-point").click(function(){
  //     // e.preventDefault(); 
  //     $('.tool-content span').show();
  // });
  ...
  $(".img-info > figure > img").responsiveImage({
    type: 'image',
  });
  ...
  if (window.innerWidth < 767) {
    $('.menu-id ul li').mouseover(function (e) {
      e.preventDefault()
    });
    $('.menu-id ul li').mouseleave(function (e) {
      e.preventDefault()
    });
    $('.menu-id ul li span').click(function (e) {
      e.preventDefault();
      if ($(this).parent().hasClass('active')) {
        $(this).parent().find('> .drop-submenu').removeAttr('style');
        $(this).parent().removeClass('active');
        $('body').removeAttr('style');

      } else {
        $('.menu-id ul li').not($(this).parent()).removeClass('active').find('> .drop-submenu').removeAttr('style');
        $(this).parent().find('> .drop-submenu').css({
          'top': ($(this).offset().top - $(window).scrollTop()) + 50,
          'visibility': 'visible',
          'opacity': '1'
        });
        $(this).parent().addClass('active');
  ...
  //hasTouch(); // remove hover on device
});
...
$(document).mouseup(function (e) {
  if ($(e.target).closest(".menu-id .wrapper-medium ul li").length === 0) {
    $('body').removeAttr('style');
    $('.menu-id .wrapper-medium ul li').removeClass('active').find('> .drop-submenu').removeAttr('style');
  }
